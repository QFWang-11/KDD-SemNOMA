...
import numpy as np
import datetime
from models.losses import Sum_MAE, PSNR
...
def train(net, EPOCH, train_loader, valid_loader, checkpoint_path='checkpoint_PerfectSIC_A1_M_32_mult_1_no_bind_mae_embed_1decoders_2user_Rayleigh_FFHQ256_54.pth'):
    # optimizer
    ...
    best_loss = 200
    # Training
    writer = SummaryWriter('./path_2users/to/log_monitor_PerfectSIC_A1_M_32_mult_1_no_bind_mae_embed_1decoders_2user_Rayleigh_FFHQ256_54')
    ...
    for epoch in range(start_epoch, EPOCH):
        ...
        if loss_val < best_loss:
            best_loss = loss_val
            torch.save(net.state_dict(), 'UL_NOMA_2_Users_Perfect_SIC_A1_M_32_mult_1_no_bind_mae_embed_1decoders_Rayleigh_FFHQ256_54.pth')
            print('model saved')
...
num_devices = 2
M = 32
net_teacher_head = Teacher_Model_Rayleigh(num_devices=num_devices, M=M).cuda()
EPOCH = 1000
train(net_teacher_head, EPOCH, train_loader, valid_loader)