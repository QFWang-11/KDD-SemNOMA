...
#----------------------------FAKD loss--------------------------------
# Spatial dimension affine transformation
...
# Calculate Gram matrix between feature maps to measure relationships between features
# fm1 and fm2 can come from different layers of the same model, spatial dimensions may differ
# Distill cross-layer feature relationships, extract two sets of features from student and teacher models
